...
(0, _jquery2.default)(document).ready(function () {
    ...
    //Slider Code------------------
    (0, _jquery2.default)('.swiper-container').each(function (index) {

        var phone = (0, _jquery2.default)(this).attr('data-phone-slides');
        if (!phone) {
            phone = 1;
        }

        var tablet = (0, _jquery2.default)(this).attr('data-tablet-slides');
        if (!tablet) {
            tablet = 1;
        }

        var desktop = (0, _jquery2.default)(this).attr('data-desktop-slides');
        if (!desktop) {
            desktop = 1;
        }

        var time = (0, _jquery2.default)(this).attr('data-time');
        if (!time) {
            time = 1000000;
        }

        var loop = (0, _jquery2.default)(this).attr('data-loop');
        if (!loop) {
            loop = false;
        }

        var swiper = new Swiper((0, _jquery2.default)(this)[0], {
            navigation: {
...
(0, _jquery2.default)(document).ready(function () {
    ...
    _jquery2.default.each((0, _jquery2.default)('.geturl'), function (index, value) {
        (0, _jquery2.default)(value).attr('href', (0, _jquery2.default)(value).attr('href') + '?url=' + location.href);
    });
    ...
    //-------------------------------------------------------------------------
    (0, _jquery2.default)('.scheduler').each(function (index, value) {
        (0, _jquery2.default)(this).hide();
        if (new Date().getTime() > parseInt((0, _jquery2.default)(this).attr('starttime')) && parseInt((0, _jquery2.default)(this).attr('endtime')) > new Date().getTime()) {
            (0, _jquery2.default)(this).show();
        }
        if ((0, _jquery2.default)(this).attr('starttime') == "" && parseInt((0, _jquery2.default)(this).attr('endtime')) > new Date().getTime()) {
            (0, _jquery2.default)(this).show();
        }
        if (new Date().getTime() > parseInt((0, _jquery2.default)(this).attr('starttime')) && (0, _jquery2.default)(this).attr('endtime') == "") {
            (0, _jquery2.default)(this).show();
        }
        if ((0, _jquery2.default)(this).attr('starttime') == "" && (0, _jquery2.default)(this).attr('endtime') == "") {
            (0, _jquery2.default)(this).show();
        }
    });
